...
В настройках приемников можно выбрать платформу/ы, на которых они будут работать - поле ```Platform``` - если платформа будет отличаться от указанных, то приемник не добавится в коллекцию всех приемников.
